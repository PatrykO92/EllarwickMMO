...
-- AddForeignKey
ALTER TABLE "PlayerOutfit" ADD CONSTRAINT "PlayerOutfit_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "Player"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PlayerOutfit" ADD CONSTRAINT "PlayerOutfit_outfit_id_fkey" FOREIGN KEY ("outfit_id") REFERENCES "Outfit"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
